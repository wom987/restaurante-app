...
function Car() {
  ...
  function calculatePaymentDetail() {
    ...
    let ivaFixed = Number(iva).toFixed(2);
    let totalFixed = Number(total).toFixed(2);
        ...
        >
          ...
          >
            <View style={{ flexDirection: "column" }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
                <Text style={style.prices}>
                  $ {Number(item.priceProduct).toFixed(2)}
                </Text>
            ...
            <View style={{ alignItems: "center", justifyContent: "center" }}>
              <TouchableOpacity
                onPress={() => {
                  deleteProductItem(item.product_id);
                }}
              >
                <Image
  ...
  return (
    ...
    >
      ...
      <View style={[style.main]}>
        ...
        />
        <TouchableOpacity
          style={[style.add, { marginStart: 30, marginEnd: 30 }]}
          onPress={() => {
        ...
        >
          ...
          >
            ...
            />
            <Text
              style={{ fontWeight: "bold", fontSize: 22, color: "#2AB059" }}
            >
              Seguir comprando.
            </Text>
          </View>
      ...
      <View style={{ marginTop: "auto" }}>
        <ItemShadowPrice>
          <View style={style.detail}>
            <View style={{ flexDirection: "column" }}>
              <Text
                style={{ fontWeight: "400", fontSize: 20, color: "#A1A1A1" }}
              >
                Subtotal
              </Text>
              <Text
            ...
            <View>
              <Text
                style={{ fontWeight: "bold", fontSize: 20, color: "#646464" }}
              >
                $ {calculatePaymentDetail().subtotal}
              </Text>
              <Text
                style={{ fontWeight: "bold", fontSize: 20, color: "#646464" }}
              >
                $ {calculatePaymentDetail().iva}
              </Text>
              <Text
                style={{ fontWeight: "bold", fontSize: 20, color: "#646464" }}
              >
